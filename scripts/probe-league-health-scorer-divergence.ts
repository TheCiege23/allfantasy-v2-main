...
console.log('')
console.log('    hub-engine   base 30 + trades + claims + chat + lineup-rate bonus   FLOOR 30')
...
console.log('')
console.log('  🛑 TWO OF THE THREE CANNOT REPORT A DEAD LEAGUE AS DEAD. Their bases are')
console.log('  additive and every term is non-negative, so no input reaches zero. Only the')
console.log('  behavioural score can, which is why D10 keeps that one.')
console.log('')
console.log('  And they agree exactly where it does not matter: on a healthy league the spread')
console.log('  collapses. The disagreement is concentrated on the league needing attention.')
console.log('')
