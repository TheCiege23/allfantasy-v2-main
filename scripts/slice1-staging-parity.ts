...
;(async () => {
  ...
  console.log(`Slice 1 staging parity — DB target: ${describeDbTarget(dbTargetUrl)}`)
  assertNonProductionDbTarget({ script: 'slice1-staging-parity', url: dbTargetUrl, action: 'seeds and mutates league rows', exitCode: 2 })
