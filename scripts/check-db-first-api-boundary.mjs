...
function getAllSourceFiles(rootDir) {
  ...
  /*
   * Segment-wise, because git hands back whole relative paths rather than a directory to prune.
   * Same two tests the walk applies to a directory entry, applied to every segment of a path.
   */
