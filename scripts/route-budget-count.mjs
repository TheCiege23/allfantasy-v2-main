...
const KEEP = new Set([
  ...
  // Fetched by components/admin/UsageAnalyticsPanel from app/leagues/[leagueId]/admin/model/page.tsx
  // (a league page, which ships); usage/log is end-user client telemetry.
