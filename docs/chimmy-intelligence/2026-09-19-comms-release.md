...
Chimmy can retrieve selected-league trade activity together with the caller's roster, normalized scoring, lineup rules and waiver context. The drawer shows accessible native redraft proposals and approvals, plus the existing completed-trade history. Private proposals remain participant-only. Snapshot fairness and realized scoring grades are explicitly distinguished from current roster-fit advice; missing valuation data does not produce a guessed grade.
