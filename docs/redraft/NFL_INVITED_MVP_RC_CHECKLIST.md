...
- Final RC SHA: recorded in the G61 completion report after commit
- Commit status: pending at document preparation
- Clean-worktree/source-certification/reproducibility status: recorded by exact-SHA G61 evidence after commit
