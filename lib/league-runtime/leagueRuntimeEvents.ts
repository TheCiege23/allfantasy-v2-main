...
const LEGACY_EVENT_TYPE_ALIASES: Record<string, CanonicalLeagueRuntimeEventType> = {
  ...
  playoff_qualification_calculated: 'playoffs.qualification.calculated',
  playoffs_qualification_calculated: 'playoffs.qualification.calculated',
  playoff_seeds_updated: 'playoffs.seeds.updated',
  playoffs_seeds_updated: 'playoffs.seeds.updated',
  playoff_bracket_generated: 'playoffs.bracket.generated',
  playoffs_bracket_generated: 'playoffs.bracket.generated',
  playoff_bracket_locked: 'playoffs.bracket.locked',
  playoffs_bracket_locked: 'playoffs.bracket.locked',
  playoff_round_opened: 'playoffs.round.opened',
  playoffs_round_opened: 'playoffs.round.opened',
  playoff_matchup_created: 'playoffs.matchup.created',
  playoffs_matchup_created: 'playoffs.matchup.created',
  playoff_qualification_snapshot_updated: 'playoffs.qualification_snapshot.updated',
  playoff_advancement: 'playoffs.advancement',
  playoffs_advancement: 'playoffs.advancement',
  playoff_team_advanced: 'playoffs.team.advanced',
  playoffs_team_advanced: 'playoffs.team.advanced',
  playoff_team_eliminated: 'playoffs.team.eliminated',
  playoffs_team_eliminated: 'playoffs.team.eliminated',
  playoff_reseeded: 'playoffs.reseeded',
  playoffs_reseeded: 'playoffs.reseeded',
  consolation_bracket_generated: 'playoffs.consolation.generated',
  playoff_consolation_generated: 'playoffs.consolation.generated',
  playoffs_consolation_generated: 'playoffs.consolation.generated',
  championship_matchup_created: 'playoffs.championship.matchup.created',
  playoff_championship_matchup_created: 'playoffs.championship.matchup.created',
  playoffs_championship_matchup_created: 'playoffs.championship.matchup.created',
  champion_crowned: 'playoffs.champion.crowned',
  playoff_champion_crowned: 'playoffs.champion.crowned',
  playoffs_champion_crowned: 'playoffs.champion.crowned',
  final_standings_recorded: 'playoffs.final_standings.recorded',
  playoff_final_standings_recorded: 'playoffs.final_standings.recorded',
  playoffs_final_standings_recorded: 'playoffs.final_standings.recorded',
  season_completed: 'season.completed',
  player_injury_update: 'player.injury.updated',
  player_data_refreshed: 'player.data.refreshed',
  player_status_changed: 'player.status.changed',
  player_injury_status_changed: 'player.injury.status_changed',
  player_projection_updated: 'player.projection.updated',
  player_team_changed: 'player.team.changed',
  player_data_fallback_used: 'player.data.fallback_used',
  player_data_fallback: 'player.data.fallback_used',
  ...
  commissioner_playoff_override: 'commissioner.playoff_override',
  commissioner_announcement_created: 'commissioner.announcement.created',
  commissioner_announcement: 'commissioner.announcement.created',
  league_chat_message: 'league.chat.message',
  league_chat_system_message: 'league.chat.system_message',
  system_chat_message: 'league.chat.system_message',
