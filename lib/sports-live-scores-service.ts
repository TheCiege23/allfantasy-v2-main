...
/**
 * Moved to `lib/scores/liveSourceSelection.ts` so `lib/workers/api-chain.ts`
 * can use the same rule without closing an import cycle back through this
 * module. Re-exported here because three modules and a test suite import it
 * from this path.
 */
export { pickFreshestSourceRows } from '@/lib/scores/liveSourceSelection'
export type { SourcedRow } from '@/lib/scores/liveSourceSelection'
