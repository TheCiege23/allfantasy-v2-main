    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-cyan-100/90">AF War Room</span>
          {data?.fallback ? (
      ...
      {!collapsed && (
        <div className="space-y-3 p-3">
          ...
          {!loading && !data && !error ? (
            <p className="py-2 text-center text-[11px] text-white/45">AF War Room activates when the draft board is live.</p>
          ) : null}
        </div>
      )}
    </section>
