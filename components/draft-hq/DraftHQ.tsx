 ...
 *   pick inventory   Needs per-pick ownership including traded picks. Not modelled.
...
export default function DraftHQ({ data }: { data: DraftHQData }) {
  const { lottery, queue, settings, lastMock } = data
          ...
          <Card title="Not computed yet">
            ...
            */}
            <p className="text-xs leading-relaxed text-white/50">
              Pick inventory, per-player confidence scores and positional-need bars aren&apos;t
              wired yet. They need pick ownership and the live recommendation engine, and we&apos;d
              rather show nothing than a number we can&apos;t stand behind.
            </p>
          </Card>
        </aside>
      </div>
