...
/*
 * Donations only. This page also sold a $9.99 "Bracket Lab Pass" behind `?mode=lab`,
 * which unlocked nothing — see app/api/stripe/create-checkout-session/route.ts. An old
 * `?mode=lab` link now simply lands on the donation form.
 */
export default function DonatePage() {
  ...
  const title = "Support AllFantasy"
  const subtitle = "Optional support to fund servers, data costs, and performance."
