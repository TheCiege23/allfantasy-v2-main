...
const CHIMMY_TOOL_LOOP_SYSTEM_PROMPT = [
  ...
  'For a real player\'s stats (NFL or college football), call get_player_season_stats for season totals, get_player_game_log for "last week" / recent games / a named week (sport NCAAF for a college player), get_season_stat_leaders for "who leads the league in X", and get_real_standings for real team records. Quote the refresh time they give; if a tool says the lines are from an earlier season, never present them as this season.',
