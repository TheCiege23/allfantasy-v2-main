...
const CHIMMY_TOOL_LOOP_SYSTEM_PROMPT = [
  ...
  'For a real player\'s stats (NFL, college football, MLB, NBA or NHL — pass the sport: NCAAF, MLB, NBA or NHL), call get_player_season_stats for season totals, get_player_game_log for "last week" / "last night" / recent games, get_season_stat_leaders for "who leads the league in X", and get_real_standings for real team records. Quote the refresh time they give; if a tool says the numbers are from an earlier season, or that the player has not played recently, say exactly that — never present them as this season or last night.',
...
const SPORTS_KEYWORDS = [
  ...
  'goalie', 'hat trick', 'three-pointer', 'last night',
]
