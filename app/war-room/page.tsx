...
export const metadata: Metadata = {
  ...
  description:
    'Use AF War Room as your AI-powered fantasy football draft assistant with pick recommendations, tier alerts, roster strategy, and multi-sport draft previews.',
}
...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Configure scoring, roster rules, and draft preferences so your AF War Room is calibrated to your exact league.',
    style: 'emerald',
  },
] as const
  ...
  return (
    <div className="min-h-screen bg-[#050814] text-white">
      ...
      <div className="sr-only">
        ...
        <h2>Dynasty Draft AF War Room</h2>
      ...
      <div className="mx-auto max-w-5xl space-y-16 px-4 pb-24 sm:px-6 lg:px-8">
        ...
        <section>
          ...
          <h2 className="mb-6 text-[22px] font-black text-white">AF War Room Features</h2>
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mb-7 max-w-md text-[13px] leading-relaxed text-white/50">
            Start with a mock draft to experience AF War Room, then connect your Sleeper leagues for
