  ...
  const homeLoads: HomeLoads | null = !isHome3a
    ...
    : homeScoped && homePlayed.length === 0
      ...
      : (() => {
         ...
         *
         * 🛑 NEVER ON A SCOPED HOME. The summary is the user's WHOLE portfolio (it re-derives the
         * league list itself), so on a home filtered to one sport or platform it would show every
         * league's scores under a "Showing NBA leagues" note. A scoped home reads its own leagues.
         */
