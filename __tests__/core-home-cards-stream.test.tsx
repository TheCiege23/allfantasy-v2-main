 ...
 * reads; the portfolio-summary cases below switch the shared flag on. The summary readers are
 * stubbed: what they do is lib/core-app's own suites' business, WHEN the page uses them is this one's.
 */
...
vi.mock('@/lib/core-app/weekAllSummary', () => ({ readWeekAllSummary: vi.fn(async () => null) }))
